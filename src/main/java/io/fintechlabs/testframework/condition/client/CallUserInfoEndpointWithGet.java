 ...
 *
 */
public class CallUserInfoEndpointWithGet extends AbstractCondition {

	private static final Logger logger = LoggerFactory.getLogger(CallUserInfoEndpointWithGet.class);

	/**
	 * @param testId
	 * @param log
	 */
	public CallUserInfoEndpointWithGet(String testId, TestInstanceEventLog log, ConditionResult conditionResultOnFailure, String... requirements) {
	 ...
	 */
	@Override
	@PreEnvironment(required = { "server", "userinfo_endpoint_request_headers" })
	...
	public Environment evaluate(Environment env) {
		...
		if (!env.containsObject("userinfo_endpoint_request_headers")) {
			throw error("Couldn't find userinfo request headers");
		}
...
//			HttpEntity<MultiValueMap<String, String>> request = new HttpEntity<>(null, headers);
			...
			try {
				...
				logSuccess("Got a response from the userinfo endpoint with GET method", args("body", responseBody, "headers", responseHeaders, "status_code", responseCode));
				return env;
