 ...
 */
@PublishTestModule(
	testName = "openid-op-scope-email",
	displayName = "OpenID OP-Scope-Email",
	profile = "OIDFBasic",
	configurationFields = {
		"server.discoveryUrl",
		"client.client_id",
	...
	summary = "Scope requesting email claims"
)
public class OpenId_OP_Scope_Email extends OpenId_OP_Scope_Base {

	public static Logger logger = LoggerFactory.getLogger(OpenId_OP_Scope_Email.class);
