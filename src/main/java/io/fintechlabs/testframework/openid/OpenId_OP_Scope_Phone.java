 ...
 */
@PublishTestModule(
	testName = "openid-op-scope-phone",
	displayName = "OpenID OP-Scope-Phone",
	profile = "OIDFBasic",
	configurationFields = {
		"server.discoveryUrl",
		"client.client_id",
	...
	summary = "Scope requesting phone claims"
)
public class OpenId_OP_Scope_Phone extends OpenId_OP_Scope_Base {

	public static Logger logger = LoggerFactory.getLogger(OpenId_OP_Scope_Phone.class);
