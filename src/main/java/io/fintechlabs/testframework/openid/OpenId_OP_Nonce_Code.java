 ...
 */
@PublishTestModule(
	testName = "openid-op-nonce-code",
	displayName = "OpenID OP-Nonce-Code",
	profile = "OIDFBasic",
	configurationFields = {
		"server.discoveryUrl",
		"client.client_id",
	...
	summary = "ID Token has nonce when requested for code flow"
)
public class OpenId_OP_Nonce_Code extends OpenIdBaseModule {

	public static Logger logger = LoggerFactory.getLogger(OpenId_OP_Nonce_Code.class);
