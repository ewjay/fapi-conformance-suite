...
import io.fintechlabs.testframework.condition.client.AddFormBasedBearerToUserInfoRequest;
 ...
 */
@PublishTestModule(
	testName = "openid-op-userinfo-body",
	displayName = "OpenID OP-UserInfo-Body",
	profile = "OIDFBasic",
	configurationFields = {
		"server.discoveryUrl",
		"client.client_id",
	...
	summary = "UserInfo Endpoint access with POST and bearer body"
)
public class OpenId_OP_UserInfo_Body extends OpenIdBaseModule {

	public static Logger logger = LoggerFactory.getLogger(OpenId_OP_UserInfo_Body.class);
	...
	protected void handleCustomCallback() {
		...
		callAndStopOnFailure(AddFormBasedBearerToUserInfoRequest.class);
