 ...
 */
@PublishTestModule(
	testName = "openid-op-clientauth-basic-dynamic",
	displayName = "OpenID OP-ClientAuth-Basic-Dynamic",
	profile = "OIDFBasic",
	configurationFields = {
		"server.discoveryUrl",
		"client.client_id",
	...
	summary = "Access token request with client_secret_basic authentication"
)
public class OpenId_OP_ClientAuth_Basic_Dynamic extends OpenIdBaseModule {

	public static Logger logger = LoggerFactory.getLogger(OpenId_OP_ClientAuth_Basic_Dynamic.class);

	@Override
	protected void configureDynamicClientRegistration(JsonObject config) {
		config.addProperty("token_endpoint_auth_method", "client_secret_basic");
	}
