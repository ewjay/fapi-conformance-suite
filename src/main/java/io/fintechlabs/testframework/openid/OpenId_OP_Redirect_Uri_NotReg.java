 ...
 */
@PublishTestModule(
	testName = "openid-op-redirect-uri-notreg",
	displayName = "OpenID OP-Redirect_Uri-NotReg",
	profile = "OIDFBasic",
	configurationFields = {
		"server.discoveryUrl",
		"client.client_id",
	...
	summary = "Sent redirect_uri does not match a registered redirect_uri"
)
public class OpenId_OP_Redirect_Uri_NotReg extends OpenIdBaseModule {

	public static Logger logger = LoggerFactory.getLogger(OpenId_OP_Redirect_Uri_NotReg.class);
	...
	protected void configureAuthorizationRequestParameters() {
		...
		env.putString("redirect_uri_suffix", "1234");
