 ...
 */
@PublishTestModule(
	testName = "openid-op-idtoken-rs256",
	displayName = "OpenID OP-IDToken-RS256",
	profile = "OIDFBasic",
	configurationFields = {
		"server.discoveryUrl",
		"client.client_id",
	...
	summary = "Asymmetric ID Token signature with RS256"
)
public class OpenId_OP_IDToken_RS256 extends OpenIdBaseModule {

	public static Logger logger = LoggerFactory.getLogger(OpenId_OP_IDToken_RS256.class);
	...
	protected void handleCustomCallback() {
		...
		callAndStopOnFailure(ValidateIdTokenNonce.class);
