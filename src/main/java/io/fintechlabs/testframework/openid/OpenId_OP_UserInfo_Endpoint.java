 ...
 */
@PublishTestModule(
	testName = "openid-op-userinfo-endpoint",
	displayName = "OpenID OP-UserInfo-Endpoint",
	profile = "OIDFBasic",
	configurationFields = {
		"server.discoveryUrl",
		"client.client_id",
...
public class OpenId_OP_UserInfo_Endpoint extends OpenIdBaseModule {

	public static Logger logger = LoggerFactory.getLogger(OpenId_OP_UserInfo_Endpoint.class);
