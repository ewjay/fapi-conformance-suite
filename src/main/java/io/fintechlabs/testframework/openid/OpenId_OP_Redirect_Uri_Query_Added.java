 ...
 */
@PublishTestModule(
	testName = "openid-op-redirect-uri-query_added",
	displayName = "OpenID OP-Redirect_Uri-Query-Added",
	profile = "OIDFBasic",
	configurationFields = {
		"server.discoveryUrl",
		"client.client_id",
	...
	summary = "Request with redirect_uri with query component when registered redirect_uri has no query component"
)
public class OpenId_OP_Redirect_Uri_Query_Added extends OpenIdBaseModule {

	public static Logger logger = LoggerFactory.getLogger(OpenId_OP_Redirect_Uri_Query_Added.class);
	...
	protected void configureAuthorizationRequestParameters() {
		...
		env.putString("redirect_uri_suffix", "?foo=bar");
