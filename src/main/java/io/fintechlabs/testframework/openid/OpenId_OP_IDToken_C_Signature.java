 ...
 */
@PublishTestModule(
	testName = "openid-op-idtoken-c-signature",
	displayName = "OpenID OP-IDToken-C-Signature",
	profile = "OIDFBasic",
	configurationFields = {
		"server.discoveryUrl",
		"client.client_id",
	...
	summary = "Does the OP sign the ID Token and with what"
)
public class OpenId_OP_IDToken_C_Signature extends OpenIdBaseModule {

	public static Logger logger = LoggerFactory.getLogger(OpenId_OP_IDToken_C_Signature.class);
